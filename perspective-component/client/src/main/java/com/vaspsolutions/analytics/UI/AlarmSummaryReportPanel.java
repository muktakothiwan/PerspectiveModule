...
public class AlarmSummaryReportPanel extends JPanel {
	...
	public AlarmSummaryReportPanel(ReportsTable reportTable, ModuleRPC rpc,int duration,boolean allProjects, String projecName) {
	...
	public JFreeChart createDurationRingchartGraph(){
		...
		Dataset alarmSummaryData = this._rpc.getTop10AlarmsByDuration(_projectName, _allProjects, _duration);
	...
	public JFreeChart createFrequencyRingchartGraph(){
		...
		int pieDataSize = 0;
		//Dataset alarmSummaryDaata = _rpc.alarmSummaryReportRingChart(projectName, allProjects, this._duration,)
		Dataset alarmSummaryData = this._rpc.alarmSummaryReportRingChart(this._projectName, this._allProjects, this._duration);
		if(alarmSummaryData != null){
			int datasetSize = alarmSummaryData.getRowCount();
			List<String> tagArray = new ArrayList<String>();
			double totalForPercentage = 0;
	...
	{
		Dataset alarmsByHourData = _rpc.getAlarmCountsPerDuration(this._projectName, this._allProjects, this._duration);
