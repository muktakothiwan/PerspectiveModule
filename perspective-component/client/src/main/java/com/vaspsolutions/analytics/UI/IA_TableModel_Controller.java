 ...
 * 
 */
public class IA_TableModel_Controller extends AbstractTableModel {

	private Object[] _columnNames = {"Gateway", "Project", "Users", "Sessions", "Avg. Session Duration", "Actions", "Remove"};
